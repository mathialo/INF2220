...
Innhold og eksempler er basert på stoff fra læreboka, forelesninger, Wikipedia, tidligere eksamener, mine egne obliger og et tilsvarende kompendium laget av Veronika Heimsbakk\footnote{http://folk.uio.no/veronahe/}.
...
\input{kompleksitet.tex}		% ferdig, mangler indexer
~\\~\\
\input{paradigmer.tex}			% ferdig, mangler indexer
~\\~\\
\input{traer.tex}
~\\~\\
\input{grafer.tex}
...
\input{sortering.tex}
~\\~\\
\input{bevis.tex}				% ferdig, mangler indexer
