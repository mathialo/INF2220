...
\noindent\mono{TCCTATTCT\textcolor{red}{T}}\\
\mono{---TCCTATT\textcolor{red}{C}TT}

\item Så sjekker vi \textit{ikke}-\mono{TT}. Dette finner vi etter ett shift. \\
\noindent\mono{TCCTATTC\textcolor{red}{TT}}\\
\mono{--TCCTATT\textcolor{red}{CT}T}

\item For å finne \textit{ikke}-\mono{CTT} må vi flytte 3 steg; til \mono{ATT}. \\
\noindent\mono{TCCTATT\textcolor{red}{CTT}}\\
\mono{------TCCT\textcolor{red}{ATT}CTT}
