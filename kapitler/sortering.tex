...
\end{bevis}
Vi har da et korollar til teorem \ref{teo:sortbound} som gir oss en nedre grense for algoritmer som bytter naboelementer:
...
\paragraph{Kompleksitet}
Vi ser at gjennomsnittlig er innstikksortering $ O(n^2) $, som gjør algoritmen uegnet til store lister. Når lista er liten derimot (typisk mindre enn 50 elementer lang) er innstikksortering en ganske god algoritme - til og med bedre enn \nameref{quick}. Gode quicksortimplementasjoner bruker derfor innstikksortering hvis lista blir for kort. 
