\section{Tekstalgoritmer}
	...
	\subsection{Boyer-Moore}
		...
		\end{itemize}
		Merk at når vi snakker om å skippe så er det alltid i forhold til det siste tegnet i nåla. Vær også obs på, som det står i algoritmen, at når vi bruker denne for eksempel på eksamen, vil vi skippe maks av \mono{badCharShift[c]} og \mono{goodSuffixShift[c]}, der \mono{c} er tegnet.
